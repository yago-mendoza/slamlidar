...
Public
tthom289/pointcloud-reconstruction
Go to file
t
Name		
tthom289
...
2 weeks ago
.gitignore
Initial commit: offline point cloud reconstruction pipeline
3 weeks ago
LICENSE
Add MIT License to the project
2 weeks ago
README.md
Update README with link and requirements clarification
2 weeks ago
flythrough.py
Initial commit: offline point cloud reconstruction pipeline
3 weeks ago
...
MIT license
StaticScan
 Screen.Recording.2026-03-12.111637_compressed.mp4 
...
Read bag — decoder encoder and point cloud messages
Deskew all scan frames
Build overlapping slices and ICP-align (chain → refine → re-chain)
Merge core points with aligned transforms and write PCD
